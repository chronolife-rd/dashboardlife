...
from_time       = "2022-09-09 13:00:00" # "2022-10-21 09:00:00"
to_time         = "2022-09-09 13:10:00" # "2022-10-21 09:05:00"
time_zone       = 'UTC'
end_user        = "7k6Hs3" # 7k6Hs3 3JLqh6
...
print('respiratory_rate_quality_index quality index thoracic', dict_result["respiratory_rate_quality_index"])
print('respiratory_rate thoracic moyenne en brpm            ', dict_result["breath_1_brpm"], 'CPM')
print('respiratory_rate_var thoracic en s                   ', dict_result["breath_1_brv"])
print('respiratory_rate abdominal moyenne en brpm           ', dict_result["breath_2_brpm"], 'CPM')
print('respiratory_rate_var abdominal en s                  ', dict_result["breath_2_brv"])

print()
print("======================================================================")
print('breath_1_peaks                                     ', dict_result["breath_1_peaks"][0][:3])
print('breath_2_peaks                                     ', dict_result["breath_2_peaks"][0][:3])
print('breath_1_valleys                                   ', dict_result["breath_1_valleys"][0][:3])
print('breath_2_valleys                                   ', dict_result["breath_2_valleys"][0][:3])
print('breath_1_inspi_over_expi                           ', dict_result["breath_1_inspi_over_expi"][0][:3])
print('breath_2_inspi_over_expi                           ', dict_result["breath_2_inspi_over_expi"][0][:3])
...
print('heartbeat                                    ', dict_result["heartbeat"], 'BPM')
print('HRV                                          ', dict_result["HRV"])
print('RR interval                                  ', dict_result["rr_interval"], 'ms')
print('sdnn                                         ', dict_result["sdnn"])
print('rmssd                                        ', dict_result["rmssd"])
print('lnrmssd                                      ', dict_result["lnrmssd"])
print('pnn50                                        ', dict_result["pnn50"], '%') # a percentage
print('qt_length_median_corrected                   ', dict_result["qt_length_median_corrected"], 'ms') # corrected is made with the supression of obvious outliers
print('qt_c_framingham_per_seg                      ', dict_result["qt_c_framingham_per_seg"], 'ms corrected to BPM')
print()
print("======================================================================")
print('5 first q_start_time of first clean segment ', dict_result["q_start"][0][:3])
print()
print('5 first r_peak_time of first clean segment  ', dict_result["r_peak"][0][:3])
print()
print('5 first t_stop_time of first clean segment  ', dict_result["t_stop"][0][:3])


print()
print("======================================================================")
print("========================= Temperature ================================")
print('averaged_temp_1          ', dict_result["averaged_temp_1"], '°C')
print('averaged_temp_2          ', dict_result["averaged_temp_2"], '°C')
